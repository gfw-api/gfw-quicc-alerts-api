...
API](http://gfw-api.github.io/swagger-ui/?url=https://raw.githubusercontent.com/gfw-api/gfw-quicc-alerts-api/master/app/microservice/swagger.yml#/QUICC)

## First time user
Perform the following steps:
* [Install docker](https://docs.docker.com/engine/installation/)
* Clone this repository: ```git clone git@github.com:Vizzuality/gfw-quicc-alerts-api.git```
* Enter in the directory (cd gfw-quicc-alerts-api)
